...
public class ReturnReport extends JPanel {
    ...
    public ReturnReport(JFrame mainFrame, String userUniqueId) {
    ...
    private void generatePDF() {
        try (PDDocument document = new PDDocument()) {
            ...
            String generatedBy = "Generated by: " + returnReportDAO.getFullName(userUniqueId);
            ...
            JOptionPane.showMessageDialog(this, "PDF generated successfully and saved");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
