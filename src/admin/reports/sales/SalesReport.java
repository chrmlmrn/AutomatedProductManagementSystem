...
public class SalesReport extends JPanel {
    ...
    public SalesReport(JFrame mainFrame, String userUniqueId) {
    ...
    private void generatePDF() {
        try (PDDocument document = new PDDocument()) {
            ...
            String generatedBy = "Generated by: " + userUniqueId; // Using userUniqueId as the placeholder for the
                                                                  // generator
            ...
            // Save the document
            String userIdDate = userUniqueId + "_" + new SimpleDateFormat("yyyyMMdd").format(new Date())
                    + "_SALES_REPORT.pdf";
